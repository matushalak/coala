...
from cc.ml import MAE_logs, LeJEPA_logs
...
def train_mnist_classifier(batch_size, lr, epochs)-> ClassifierHead:
    ...
    MNIST_classifier = ClassifierHead.from_pretrained_unet(
        ...
        checkpoint_path=os.path.join(MAE_logs, "lightning_logs", "version_28", "checkpoints", "epoch=20-step=8862.ckpt"),
        # checkpoint_path=os.path.join(LeJEPA_logs, "lightning_logs", "version_11", "checkpoints", "epoch=50-step=21522.ckpt"),
        num_classes=10,
