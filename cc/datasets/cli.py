...
from cc.datasets.registry import download_dataset, get_dataloaders, list_datasets
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Dataset registry CLI for cc.datasets.")
