...
from coala import DATADIR, rCNN_logs, dataset_log_dir
...
class rCNN(nn.Module):
    ...
    def __init__(self, input_features: int = 1, V1_features: int = 16, V2_features: int = 32, V4_features: int = 64):
        ...
        self.W_v1rec = nn.Conv2d(V1_features, V1_features, kernel_size=1, padding=0, stride=1)
        ...
        self.W_v2rec = nn.Conv2d(V2_features, V2_features, kernel_size=1, padding=0, stride=1)
        ...
        self.W_v4rec = nn.Conv2d(V4_features, V4_features, kernel_size=1, padding=0, stride=1)
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--log_dir", type=str, default=rCNN_logs)
