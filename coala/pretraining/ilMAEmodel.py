...
class ilMAE(pl.LightningModule):
    '''
    Invariant-latent MAE, uses barlow-twins / VICReg style loss on the encoder's latent representation, 
        together with pixel reconstruction loss on the decoder.
    '''
    def __init__(
        self,
        num_filters: int,
